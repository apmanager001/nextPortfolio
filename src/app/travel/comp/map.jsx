...
const Map = () => {
  const data = [
    {
      id: "FRA",
      value: ["08/02/2022 - 08/16/2022", "12/03/2022 - 02/08/2023"],
      color: "#ff6347",
    }, // Tomato
  ...
  return (
    <div className="w-full">
      <div className="h-[600px] w-full mb-6 rounded-2xl overflow-hidden border border-base-300 shadow-xl">
      ...
      <div className="text-center">
        <div className="stats shadow bg-base-100 border border-base-300">
          <div className="stat">
            <div className="stat-title">Total Countries Visited</div>
            <div className="stat-value text-primary">{data.length}</div>
            <div className="stat-desc">Across 4 continents</div>
          </div>
        </div>
      </div>
    </div>
