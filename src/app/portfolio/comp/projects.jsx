  ...
  return (
    <div className="flex flex-col my-4">
      <div className="flex flex-wrap justify-center py-10 gap-8 max-w-screen-lg mx-auto">
        <div className="flex flex-col gap-2 w-3/4 md:w-80 border border-gray-600 hover:border-gray-400 rounded-2xl p-10 shadow-2xl">
          <Link
          ...
          >
            ...
            <img
              ...
              className="h-32 border border-gray-600 my-2"
              alt="project image"
            />
        ...
        <div className="flex flex-col gap-2 w-3/4 md:w-80 border border-gray-600 hover:border-gray-400 rounded-2xl p-10 shadow-2xl">
          ...
          >
            ...
            <img
              ...
              className="h-32 border border-x-gray-600 border-y-gray-600 my-2"
              alt="project image"
            />
            <div className="w-full flex flex-col gap-2 px-2">
              ...
              <div className="text-sm text-gray-500 ">
                This project was great learning how map leaflets work. The idea
                of the site is users can uplaod photos and it uses metadata to
                find the location and pin that location on the map. I also added
                using an API to find the top 10 closest Points of interest add
                it on the map.
              </div>
            </div>
          </Link>
          ...
          >
            ...
            <div className="w-full flex flex-col gap-2 px-2">
              ...
              <div className="text-sm text-gray-500 ">
                ...
                ran business. They needed a working cart that adds items. When
                the client is ready to checkout the payment is processed through
          ...
          >
            ...
            <div className="w-full flex flex-col gap-2 px-2">
              ...
              <div className="text-sm text-gray-500 ">
                ...
                allows users to focus on a few core habits to build that muscle
                to continue consistancy.
              </div>
            </div>
          </Link>
        </div>
