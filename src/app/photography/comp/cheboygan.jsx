    ...
    <div className="flex flex-col gap-6 items-center">
      ...
      <div className="card bg-base-200 shadow-lg border border-base-300">
        <div className="card-body text-center">
          ...
          <p className="text-sm text-base-content/70">
            Local adventures and nature photography from the beautiful northern
            Michigan region
          </p>
          <div className="flex justify-center gap-4 mt-2">
            <div className="badge badge-primary">Nature</div>
            <div className="badge badge-secondary">Local</div>
            <div className="badge badge-accent">Adventure</div>
          </div>
        </div>
      </div>
    </div>
