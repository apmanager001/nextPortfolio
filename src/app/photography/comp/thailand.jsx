    ...
    <div className="flex flex-col gap-6 items-center">
      ...
      <div className="card bg-base-200 shadow-lg border border-base-300">
        <div className="card-body text-center">
          <h3 className="card-title justify-center text-lg">Thailand</h3>
          <p className="text-sm text-base-content/70">
            Exploring the vibrant culture, stunning temples, and beautiful
            landscapes of Southeast Asia
          </p>
          <div className="flex justify-center gap-4 mt-2">
            <div className="badge badge-primary">Culture</div>
            <div className="badge badge-secondary">Temples</div>
            <div className="badge badge-accent">Landscapes</div>
          </div>
        </div>
      </div>
    </div>
